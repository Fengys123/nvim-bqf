...
local actionFuncref = {
    ...
    split = {mode = 'n', module = 'qfwin.handler', funcref = [[open(false, 'split')]]},
    vsplit = {mode = 'n', module = 'qfwin.handler', funcref = [[open(false, 'vsplit')]]},
    splitc = {mode = 'n', module = 'qfwin.handler', funcref = [[open(true, 'split')]]},
    vsplitc = {mode = 'n', module = 'qfwin.handler', funcref = [[open(true, 'vsplit')]]},
